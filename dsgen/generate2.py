...
if num_of_hofam_duplicate < 0:
    print(
        "Error: Number of Number of households and family records must be "
        + "0 or positive"
    )
    sys.exit()
...
for field_dict in field_list:
    ...
    if field_dict.get("type", "") not in ["freq", "date", "phone", "ident", "others"]:
        print(
            'Error: Illegal or no field type given for field "%s": %s'
    ...
    if field_dict.get("char_range", "") not in ["alpha", "alphanum", "digit"]:
        print(
            "Error: Illegal or no random character range given for "
            + 'field "%s": %s' % (field_dict["name"], field_dict.get("char_range", ""))
        )
        raise Exception
    ...
    if "select_prob" not in field_dict:
        ...
        print(
            "Error: Illegal value for select probability in dictionary for "
    ...
    for prob in prob_names:
        if prob not in field_dict:
            ...
            print(
                'Error: Illegal value for "%s" probability in dictionary for ' % (prob)
    ...
    if (field_prob_sum > 0.0) and (abs(field_prob_sum - 1.0) > 0.001):
        print(
            'Error: Sum of probabilities for field "%s" is not 1.0: %f'
...
print()
print(
    "Create %i original and %i duplicate records" % (num_org_records, num_dup_records)
)
print(
    "  Distribution of number of duplicates (maximal %i duplicates):" % (max_num_dups)
)
...
for field in household_freq_dict:
    try:
        ...
        print(
            "  Error: Can not open household frequency file %s"
...
while rec_cnt < num_org_records:
    ...
    for field_dict in field_list:
        ...
        if random.random() <= field_dict["miss_prob"]:
            ...
            if ("depend" in field_dict) and (
                ...
                if "," not in depend_field:  # A single dependency field
                    ...
                    if depend_value in field_dict["lookup_dict"]:
                        ...
                        print(
                            "XX: got combined dependency value: %s" % (rand_val),
                            depend_field,
                            depend_value,
                        )  #####################
            ...
            min_digit = int("1" * (int(1 + round(field_dict["num_digits"] / 2.0))))
    ...
    if rec_str not in all_rec_set:  # Check if same record already created
        ...
        if VERBOSE_OUTPUT == True:
            ...
            for field_name in field_names:
                print(
                    "    %-18s: %-30s"
                    % (field_name, rec_dict.get(field_name, missing_value))
                )
            print()
...
if num_of_hofam_duplicate > 0:
    ...
    while rec_cnt < num_of_hofam_duplicate:
        ...
        while (
            (org_rec_id in org_hofam_rec_used)
            or (org_rec_id not in org_rec)
            or (rec_age < min_age)
            or (all_fields_flag == False)
        ):
        ...
        if family_flag == True:
            ...
            prob_first = {"daughter": 0.5, "son": 0.5, "brother": 0.5, "sister": 0.5}

            # +(older) (-)younger
            prob_age_gap = {"+": 0.5, "-": 0.5}
            ...
            if num_dups > 0:
                ...
                if family_role == "husband":
                    ...
                    if random.random() <= prob_create_role["wife"]:
                        ...
                        if (
                            random.random()
                            <= prob_live_family["husband_with_wife" + str_key]
                        ):
                    ...
                    if (
                        random.random()
                        <= prob_has_children["parent_has_children" + str_key]
                    ) and (max_num_of_children > 0):
                        ...
                        while numrole < max_num_of_children:
                            ...
                            if random.random() <= prob_create_role[str_children]:
                                family_role_to_create.insert(
                                    len(family_role_to_create), str_children
                                )
                                numrole += 1
                    ...
                    if random.random() <= prob_create_role["husband"]:
                        ...
                        family_role_to_create.insert(
                            len(family_role_to_create), "husband"
                        )
                        max_num_of_children = num_dups - 1

                        if (
                            random.random()
                            <= prob_live_family["wife_with_husband" + str_key]
                        ):
                            family_role_to_create_live.insert(
                                len(family_role_to_create_live), "y"
                            )
                    ...
                    if random.random() <= prob_create_role["father"]:
                        ...
                        family_role_to_create.insert(
                            len(family_role_to_create), "father"
                        )
                        max_num_of_children = num_dups - 1

                        if (
                            random.random()
                            <= prob_live_family["son_with_father" + str_key]
                        ):
                            family_role_to_create_live.insert(
                                len(family_role_to_create_live), "y"
                            )
                    ...
                    if random.random() <= prob_create_role["mother"]:
                        ...
                        family_role_to_create.insert(
                            len(family_role_to_create), "mother"
                        )
                        max_num_of_children = num_dups - 1

                        if (
                            random.random()
                            <= prob_live_family["son_with_mother" + str_key]
                        ):
                            family_role_to_create_live.insert(
                                len(family_role_to_create_live), "y"
                            )
                    ...
                    while numrole < max_num_of_children:
                        ...
                        if random.random() <= prob_create_role[str_children]:
                            ...
                            if (
                                random.random()
                                <= prob_live_family[
                                    "brother_with_" + str_children + str_key
                                ]
                            ):
                                family_role_to_create_live.insert(
                                    len(family_role_to_create_live), "y"
                    ...
                    if random.random() <= prob_create_role["father"]:
                        ...
                        if (
                            random.random()
                            <= prob_live_family["daughter_with_father" + str_key]
                        ):
                            family_role_to_create_live.insert(
                                len(family_role_to_create_live), "y"
                            )
                    ...
                    if random.random() <= prob_create_role["mother"]:
                        ...
                        if (
                            random.random()
                            <= prob_live_family["daughter_with_mother" + str_key]
                        ):
                            family_role_to_create_live.insert(
                                len(family_role_to_create_live), "y"
                            )
                    ...
                    while numrole < max_num_of_children:
                        ...
                        if random.random() <= prob_create_role[str_children]:
                            ...
                            if (
                                random.random()
                                <= prob_live_family[
                                    str_children + "_with_sister" + str_key
                                ]
                            ):
                                family_role_to_create_live.insert(
                                    len(family_role_to_create_live), "y"
        ...
        while (dup_count < num_dups) and (rec_cnt < num_of_hofam_duplicate):
            ...
            if family_flag == True:
                ...
                if (
                    (field_name in parent_address)
                    and ("father" not in family_role_to_create)
                    and ("mother" not in family_role_to_create)
                ):
            ...
            for field_dict in field_list:
                ...
                if family_flag == True:
                    ...
                    if "age" in dup_rec_dict:
                        ...
                        if family_role_to_create[dup_count] in [
                            ...
                            if (
                                family_role_to_create[dup_count] in ["son", "daughter"]
                            ...
                            if family_role_to_create[dup_count] in [
                                ...
                                if (age_value >= age_min_move) and (
                                    random.random()
                                    <= prob_live_family[
                                        family_role_to_create[dup_count]
                                        + "_with_"
                                        + str_key1
                                        + str_key
                                    ]
                            ...
                            if (
                                ...
                                and (family_role in ["son", "daughter"])
                                and (family_role_to_create_live[dup_count] == "y")
                            ):
                                list_live_with2 = []
                                for i in range(
                    ...
                    if field_dict["type"] == "freq":  # A frequency file based field
                        ...
                        if (family_flag == False) and (field_name not in ["culture"]):
                            ...
                            if field_name in ["age", "sex"]:
                                str_key = "household_"
                            rand_num = random.randint(
                                0, freq_files_length[str_key + field_name] - 1
                            )
                        ...
                        if family_flag == True:
                            ...
                            if (
                                ...
                                if (father_mother_live_together_flag) and (
                                    ("husband" in family_role_to_create)
                                    and ("wife" in family_role_to_create)
                                ):
                                ...
                                if (father_mother_live_together_flag) and (
                                    ...
                                    and ("mother" in family_role_to_create)
                                ):
                                    parent_address = parent_father_address
                                else:
                            ...
                            if (
                                ...
                                (field_name in parent_address)
                                and (family_role_to_create[dup_count] in ["mother"])
                                and (family_role_to_create_live[dup_count] in ["n"])
                                and ("father" in family_role_to_create)
                                and father_mother_live_together_flag
                            ):
                        ...
                        if family_flag == False:
                            if (field_dict["name"] == "date_of_birth") and (
                                ...
                                year_birth = current_year - int(
                                    dup_rec_dict["age"].replace(blank_value, "")
                                )
                ...
                if (
                    (dup_field_val != old_field_val)
                    and (field_name not in field_filter)
                ) or (field_name in field_filter):
                ...
                if family_flag == True:
                    if field_name in parent_address:
                        if family_role_to_create[dup_count] in ["father", "husband"]:
                            ...
                            (family_role_to_create[dup_count] in ["mother"])
                            and ("father" not in family_role_to_create)
                        ) or (
                            (family_role_to_create[dup_count] in ["wife"])
                            and ("husband" not in family_role_to_create)
                        ):
                ...
                if VERBOSE_OUTPUT == True:
                    ...
                    for field_name in field_names:
                        print(
                            ...
                            % (
                                field_name,
                                org_rec_dict.get(field_name, missing_value),
        ...
        if type_modification == "all":  # Randomly select an error type according
            ...
            for error_type in error_type_distribution:
                list_type_of_error += [error_type] * int(
                    error_type_distribution[error_type] * 100
                )
                ...
                for m in range(num_field_mod_to_do):
                    ...
                    if type_modification_to_apply == "typ":
                        ...
                        #
                            ...
                            if (
                                ...
                                min_digit = int(
                                    "1"
                                    * (int(1 + round(field_dict["num_digits"] / 2.0)))
                                )
                                rand_num = random.randint(min_digit, max_digit)
                                dup_field_val = (
                                    area_code
                    ...
                    #
                        ...
                        if random.random() <= field_dict["pho_prob"]:
                            phonetic_changes = get_transformation(
                    ...
                    #
                        ...
                        if random.random() <= field_dict["ocr_prob"]:
                            ocr_changes = get_transformation(
                                old_field_val, type_modification_to_apply
                            )
                            if "," in ocr_changes:
