...
def check_is_string(variable, value):
  ...
  """
    ...
    if not isinstance(value, str):
        logging.exception(
            'Value of "%s" is not a string: %s (%s)'
...
def check_is_number(variable, value):
  ...
  """
    ...
    if (not isinstance(value, int)) and (not isinstance(value, float)):
        logging.exception(
            'Value of "%s" is not a number: %s (%s)'
            % (variable, str(value), type(value))
        )
        raise Exception
...
def check_is_dictionary(variable, value):
  ...
  """
    ...
    if not isinstance(value, dict):
        logging.exception(
            'Value of "%s" is not a dictionary: %s' % (variable, type(value))
        )
        raise Exception
...
def check_is_list(variable, value):
  ...
  """
    ...
    if not isinstance(value, list):
        logging.exception('Value of "%s" is not a list: %s' % (variable, type(value)))
        raise Exception
...
def check_is_set(variable, value):
  ...
  """
    ...
    if (not isinstance(value, set)) and (not isinstance(value, set)):
        logging.exception('Value of "%s" is not a set: %s' % (variable, type(value)))
        raise Exception
...
def check_is_tuple(variable, value):
  ...
  """
    ...
    if not isinstance(value, tuple):
        logging.exception('Value of "%s" is not a tuple: %s' % (variable, type(value)))
        raise Exception
...
def check_is_flag(variable, value):
  ...
  """
    ...
    if value not in [True, False]:
        logging.exception(
            'Value of "%s" is not True or False: %s' % (variable, str(value))
        )
        raise Exception
