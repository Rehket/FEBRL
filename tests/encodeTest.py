...
class TestCase(unittest.TestCase):
    ...
    def testSoundex(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        assert c == "0000", '"Soundex" of empty string is not "0000"'
        ...
        for s in self.strings:
            ...
            assert s[0] == c[0], (
                ...
                + s
                + '" differs from original string: '
                + str(c)
            )

            assert len(c) == 4, (
                'Length of "Soundex" code for string "'
                + s
                + '" is not four '
                + "characters: "
                + str(c)
    ...
    def testModSoundex(self):  # - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for s in self.strings:
            ...
            assert s[0] == c[0], (
                'First character in "ModSoundex" code for '
                + 'string "'
                + s
                + '" differs from original string: '
                + str(c)
            ...
            assert len(c) == 4, (
                'Length of "ModSoundex" code for string "'
                + s
                + '" '
                + "is not four characters: "
                + str(c)
                + " with length: "
                + str(len(c))
            )
    ...
    def testPhonex(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for s in self.strings:
            ...
            assert len(c) == 4, (
                'Length of "Phonex" code for string "'
                + s
                + '" is '
                + "not four characters: "
                + str(c)
            ...
            if len(c) > 1:
                assert c[1:].isdigit() == 1, (
                    'Characters after first in "Phonex" '
                    + 'code for string "'
                    + s
                    + '" are not digits: '
                    + str(c)
    ...
    def testPhonix(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for s in self.strings:
            ...
            assert len(c) == 4, (
                'Length of "Phonix" code for string "'
                + s
                + '" is '
                + "not four characters: "
                + str(c)
            ...
            if len(c) > 1:
                assert c[1:].isdigit() == 1, (
                    'Characters after first in "Phonix" '
                    + 'code for string "'
                    + s
                    + '" are not digits: '
                    + str(c)
    ...
    def testNYSIIS(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for s in self.strings:
            ...
            assert len(c) <= 4, (
                'Length of "NYSIIS" code for string "'
                + s
                + '" is '
            ...
            if len(c) > 1:
                assert c[1:].isalpha() == 1, (
                    'Characters after first in "NYSIIS" '
                    + 'code for string "'
                    + s
                    + '" are not letters: '
                    + str(c)
    ...
    def testDoubleMetaphone(self):  # - - - - - - - - - - - - - - - - - - - - - -
        ...
        for s in self.strings:
            ...
            assert len(c) <= 4, (
                'Length of "DoubleMetaphone" code for string "'
                + s
            ...
            if len(c) > 1:
                assert c[1:].isalpha() == 1, (
                    "Characters after first in "
                    + '"DoubleMetaphone" code for string "'
                    + s
                    + '" are not letters: '
                    + str(c)
                )
    ...
    def testFreqVector(self):  # - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        assert c == "", '"freq_vector" of empty string is not an empty string'
