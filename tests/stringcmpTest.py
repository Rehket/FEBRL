...
class TestCase(unittest.TestCase):
    ...
    def testWinkler(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"Winkler" does not return a floating point number for:' + str(pair)
    ...
    def testBagDist(self):  # - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"BagDist" does not return a floating point number for: ' + str(pair)
            ...
            if pair[0] == pair[1]:
                ...
                assert (
                    approx_str_value == 1.0
                ), '"BagDist" does not return 1.0 if strings are equal: ' + str(pair)
    ...
    def testEditDist(self):  # - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"EditDist" does not return a floating point number for: ' + str(pair)
            ...
            if pair[0] == pair[1]:
                ...
                assert (
                    approx_str_value == 1.0
                ), '"EditDist" does not return 1.0 if strings are equal: ' + str(pair)
    ...
    def testSeqMatch(self):  # - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"SeqMatch" does not return a floating point number for: ' + str(pair)
            ...
            if pair[0] == pair[1]:
                ...
                assert (
                    approx_str_value == 1.0
                ), '"SeqMatch" does not return 1.0 if strings are equal: ' + str(pair)
    ...
    def testCompression(self):  # - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"Compression" does not return a floating point number for: ' + str(pair)
            ...
            if pair[0] == pair[1]:
                ...
                assert (
                    approx_str_value == 1.0
                ), '"Compression" does not return 1.0 if strings are equal: ' + str(
                    pair
                )
    ...
    def testLCS(self):  # - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"LCS" does not return a floating point number for: ' + str(pair)
    ...
    def testOntoLCS(self):  # - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"OntoLCS" does not return a floating point number for: ' + str(pair)
    ...
    def testPermWinkler(self):  # - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        for pair in self.string_pairs:
            ...
            assert isinstance(
                approx_str_value, float
            ), '"PermWinkler" does not return a floating point number for:' + str(pair)
            ...
            if pair[0] == pair[1]:
                ...
                assert (
                    approx_str_value == 1.0
                ), '"PermWinkler" does not return 1.0 if strings are equal: ' + str(
                    pair
                )
            ...
            assert (
                approx_str_value_permwinkler >= approx_str_value_winkler
