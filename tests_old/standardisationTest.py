...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.names_snames = [
            ...
            ("Mister CHRISTEN, Peter", ["male", "mr", "peter", "", "christen", ""]),
            ("Christen Petra", ["female", "", "petra", "", "christen", ""]),
            ("Ms Christen, petra", ["female", "ms", "petra", "", "christen", ""]),
            ("Misses CHRISTEN, PETRA", ["female", "ms", "petra", "", "christen", ""]),
            ("peter almond", ["male", "", "peter", "", "almond", ""]),
            ("almond peter", ["male", "", "peter", "", "almond", ""]),
            ("", ["", "", "", "", "", ""]),
            ("Peter", ["male", "", "peter", "", "", ""]),
            ...
            ("mr jones Peter mary", ["male", "mr", "peter", "mary", "jones", ""]),
            (
    ...
    def testPhoneNumStandardiser(self):  # --------------------------------------
        ...
        for (rec_id, rec_list) in test_ds.readall():
            ...
            assert test_number == true_number, (i, rec_list[3:8], self.phonenums[i][1])
    ...
    def testPhoneNumStandardiserNone(self):
        ...
        for (rec_id, rec_list) in test_ds.readall():
            ...
            assert test_country_name == "", (i, rec_list[3:8], self.phonenums[i][1])
            assert test_area_code == true_area_code, (
                i,
                rec_list[3:8],
                self.phonenums[i][1],
            ...
            assert test_number == true_number, (i, rec_list[3:8], self.phonenums[i][1])
            assert test_extension == "", (i, rec_list[3:8], self.phonenums[i][1])
